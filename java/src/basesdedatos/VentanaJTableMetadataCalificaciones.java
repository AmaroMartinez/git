...
public class VentanaJTableMetadataCalificaciones extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaJTableMetadataCalificaciones frame = new VentanaJTableMetadataCalificaciones();
	 ...
	 * Create the frame.
	 */
	public VentanaJTableMetadataCalificaciones() {
		...
		try {
			...
			// Escribo la consulta
			String consulta = "SELECT * FROM calificaciones where dni= '11111111A'";
